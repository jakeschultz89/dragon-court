class Creation {
 ...
 constructor(){
  new Ajax('api/player/creation/', '', (result) => {
 ...
 attach(){
  var t = this;
   ...
   switch(type){
    ...
    this.query = (t.freePoints - cost < 0);
    ...
    if(this.query){
     ...
     t.pointChange(cause);
	  ...
	  $(document).on('click', '#creationSubmit', function(e){
	   ...
	   new Ajax('api/player/create/', createObj, (result) => {
	    DC.Game.awakenScreen();
	   });
	  });
 }
